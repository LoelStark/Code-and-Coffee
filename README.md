...
☕ Warm Coffee-themed UI — Background photo, tones, and typography

🎨 Custom Styling using CSS (glowing inputs, centered layout, soft shadows)

🔗 Create Account Link — Direction for new users
...
A simple authentication page structure suitable for integration with backend systems

A beginner-friendly yet visually appealing layout
